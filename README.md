...
<ul>
  <li>
  <a href="https://gscore-phi.vercel.app/">Gscore - Можно зарегистрироваться, зайти в аккаунт, изменить пароль, почту и имя, купить подписку, активировать коды в подписке, сменить подписку на большую или меньшую </a>
 </li>
 <li>
